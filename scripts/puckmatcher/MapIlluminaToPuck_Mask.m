function MappingOutputFolder=MapIlluminaToPuck_Mask(PuckName,MatchedPuckName,BeadType,varargin)
...
%10) ProcessedImageFolder
    ...
    display('Reading barcodes and transcript counts');
...
%     end
    ...
    if string(BeadType)=="180402"
        Illumina=MapLocationsFunTruseqUP14J(MappingOutputFolder,Bead,IlluminaBarcodesDownsampled,PrimerNLigationSequence,PrimerUPLigationSequence,NumBases,SaveData,PuckName,"NumPar",NumPar,"Mask", Mask);
    end
