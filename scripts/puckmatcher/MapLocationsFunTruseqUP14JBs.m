function Illumina=MapLocationsFunTruseqUP14JBs(OutputDirectory,Bead,IlluminaBarcodes,PrimerNLigationSequence,PrimerUPLigationSequence,NumBases,SaveData,PuckName,varargin)
