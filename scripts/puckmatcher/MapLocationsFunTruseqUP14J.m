function Illumina=MapLocationsFunTruseqUP14J(OutputDirectory,Bead,IlluminaBarcodes,PrimerNLigationSequence,PrimerUPLigationSequence,NumBases,SaveData,PuckName,varargin)
