...
def main():
    ...
    try:
        ...
        call_args = ['qsub', '-o', output_file, '-l', 'h_vmem=65G', '-notify', '-l', 'h_rt=6:0:0', '-j', 'y', '-P', 'macosko_lab', '-l', 'os=RedHat7', submission_script, manifest_file, library, locus_function_list, alignment_folder, file_name, scripts_folder, output_folder, '{}/{}_{}/{}'.format(library_folder, experiment_date, library, reference2)]
        ...
        call_args = ['qsub', '-o', output_file, '-l', 'h_vmem=45G', '-notify', '-l', 'h_rt=5:0:0', '-j', 'y', '-P', 'macosko_lab', '-l', 'os=RedHat7', submission_script, manifest_file, library, scripts_folder, locus_function_list, output_folder, '{}/{}'.format(analysis_folder, reference2)]
        call_to_taskrunner(output_folder, call_args)
        ...
        call_args = ['qsub', '-o', output_file, '-l', 'h_vmem=5g', '-notify', '-l', 'h_rt=3:0:0', '-j', 'y', '-P', 'macosko_lab', '-l', 'os=RedHat7', submission_script, manifest_file, library, scripts_folder, locus_function_list, output_folder, alignment_folder]
        call_to_taskrunner(output_folder, call_args)
